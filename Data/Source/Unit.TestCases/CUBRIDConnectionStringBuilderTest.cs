...
namespace Unit.TestCases
{
    ...
    public class CUBRIDConnectionStringBuilderTest
    {
        ...
        {
            string connString = "server=10.34.64.122;database=demodb;port=33590;user=public;password=";
        ...
        public void GetConnectionStringTest()
        {
            ...
            string encoding = "utf-8";
            CUBRIDConnectionStringBuilder target = new CUBRIDConnectionStringBuilder(server, port, database, user, password, encoding, true);
            string expected = "server=10.34.64.122;port=33590;database=demodb;user=public;password=;charset=utf-8;autocommit=1";
            ...
            Assert.AreEqual(target.Port, "33590");
