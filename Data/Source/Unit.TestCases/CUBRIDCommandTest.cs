    ...
    public class CUBRIDCommandTest
    {
        ...
        public void CUBRIDCommandConstructorTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDDataAdapter da = new CUBRIDDataAdapter())
                {
                    ...
                    Assert.AreEqual(cmd.ColumnInfos[0].Name, "code");
                    Assert.AreEqual(cmd.ColumnInfos[0].IsPrimaryKey, true);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsForeignKey, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsNullable, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].RealName, "");
                    Assert.AreEqual(cmd.ColumnInfos[0].Precision, 3);
                    Assert.AreEqual(cmd.ColumnInfos[0].Scale, 0);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsAutoIncrement, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsReverseIndex, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsReverseUnique, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].IsShared, false);
                    Assert.AreEqual(cmd.ColumnInfos[0].Type, CUBRIDDataType.CCI_U_TYPE_CHAR);
                    Assert.AreEqual(cmd.ColumnInfos[0].Table, "nation");
                }
            }
        }
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    CUBRIDCommand cmdClone = cmd.Clone();
                    {
                        using (CUBRIDDataAdapter da = new CUBRIDDataAdapter())
                        {
                            ...
                            Assert.AreEqual(cmdClone.ColumnInfos[0].Name , "code");
                            ...
                            Assert.AreEqual(cmdClone.ColumnInfos[0].Precision , 3);
                            ...
                            Assert.AreEqual(cmdClone.ColumnInfos[0].Type , CUBRIDDataType.CCI_U_TYPE_CHAR);
                            Assert.AreEqual(cmdClone.ColumnInfos[0].Table , "nation");
                        }
                    }
                }
            }
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    ...
                    using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            Assert.AreEqual(bytes.Length, bytes2.Length, "The inserted BLOB length is not valid!");
                            bool ok = true;
                            ...
                            Assert.AreEqual(ok , true, "The BLOB was not inserted correctly!");
                        }
                ...
                using (CUBRIDCommand cmd1 = new CUBRIDCommand(sql1, conn))
                {
                    ...
                    using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            Assert.AreEqual(bytes1.Length , bytes.Length, "The selected BLOB length is not valid!");
                            bool ok = true;
                            for (int i = 0; i < bytes.Length; i++)
                            {
                                if (bytes1[i] != bytes[i])
                            ...
                            Assert.AreEqual(ok, true, "The BLOB was not selected correctly!");
                        }
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    ...
                    using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            Assert.AreEqual(str.Length, str2.Length, "The inserted CLOB length is not valid!");
                ...
                using (CUBRIDCommand cmd1 = new CUBRIDCommand(sql1, conn))
                {
                    ...
                    using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            Assert.AreEqual(str.Length, str1.Length, "The selected CLOB length is not valid!");
                ...
                using (CUBRIDCommand cmd1 = new CUBRIDCommand(sql1, conn))
                {
                    ...
                    using (CUBRIDDataAdapter da = new CUBRIDDataAdapter())
                    {
                        ...
                        for (int j = 0; j < dt.Rows.Count; j++)
                        {
                            ...
                            Assert.AreEqual(bytes1.Length, bytes.Length, "The selected length is not valid!");
                            bool ok = true;
                            for (int i = 0; i < bytes.Length; i++)
                            {
                                if (bytes1[i] != bytes[i])
                    ...
                    using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                    {
                        ...
                        using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                Assert.AreEqual(bytes2.Length, bytes.Length, "The updated BLOB length is not valid!");
                                ...
                                Assert.AreEqual(ok, true, "The BLOB was not updated correctly!");
                            }
                            cmd2.Close();
                        }
                    }
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Assert.AreEqual(str.Length, str2.Length, "The selected CLOB length is not valid!");
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Assert.AreEqual(b2.BaseStream.Length, b.BaseStream.Length, "The inserted BLOB length is not valid!");
                        bool ok = true;
                        ...
                        using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                        {
                            ...
                            while (reader.Read())
                            {
                                ...
                                using (StreamReader r2 = new StreamReader("testout.txt"))
                                {
                                    ...
                                    r2.Close();
                                    Assert.AreEqual(writestring.Length, readstring.Length, "The inserted CLOB length is not valid!");
        ...
        public void Test_Blob_InsertTransaction()
        {
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                {
                    DbDataReader reader = cmd2.ExecuteReader();
                    Assert.AreEqual(reader.HasRows, false, "Transaction did not rollback!");
                }
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDCommand cmd2 = new CUBRIDCommand(sql2, conn))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Assert.AreEqual(bytes2.Length, bytes1.Length);
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        Assert.AreEqual(bytes1.Length, bytes.Length);
                        ...
                        Assert.AreEqual(ok, true, "The BLOB DELETE command was not rolled-back correctly!");
                    }
                }
        ...
        public void ExecuteNonQueryTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                try
                {
                    CUBRIDCommandTest.ExecuteSQL("drop function unit_hello", conn);
                }
                catch { }

                string sql = "CREATE FUNCTION unit_hello(a int) RETURN int AS LANGUAGE JAVA NAME 'SpCubrid.SpInt(int) return java.lang.Integer;'";
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    cmd.ExecuteNonQuery();
                }

                sql = "? = CALL unit_hello(10)";
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
