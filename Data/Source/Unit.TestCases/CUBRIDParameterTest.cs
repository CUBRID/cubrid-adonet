    ...
    public class CUBRIDParameterTest
    {
        ...
        public void Test_Write_Collection_String()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                //Create a new table with a collection
                //CUBRIDParameterTest.ExecuteSQL("CREATE TABLE t(s SET(NCHAR(4096)))", conn);
                //CUBRIDParameterTest.ExecuteSQL("CREATE TABLE t(s SET(CHAR(4096)))", conn);
                CUBRIDParameterTest.ExecuteSQL("CREATE TABLE t(s SET(NCHAR VARYING))", conn);
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    ...
                    param.ParameterName = "?p";
                    param.Value = sArray;
                    //param.InnerCUBRIDDataType = CUBRIDDataType.CCI_U_TYPE_NCHAR;
                    param.InnerCUBRIDDataType = CUBRIDDataType.CCI_U_TYPE_VARNCHAR;
