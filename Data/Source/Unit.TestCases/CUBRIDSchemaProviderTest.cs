    ...
    public class CUBRIDSchemaProviderTest
    {
        ...
        public void GetForeignKeysTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                Assert.IsTrue(dt.Rows[0][0].ToString() == "event");
                Assert.IsTrue(dt.Rows[0][1].ToString() == "code");
                Assert.IsTrue(dt.Rows[0][2].ToString() == "game");
                Assert.IsTrue(dt.Rows[0][3].ToString() == "event_code");
                Assert.IsTrue(dt.Rows[0][4].ToString() == "1");
                Assert.IsTrue(dt.Rows[0][5].ToString() == "1");
                Assert.IsTrue(dt.Rows[0][6].ToString() == "1");
                Assert.IsTrue(dt.Rows[0][7].ToString() == "fk_game_event_code");
                Assert.IsTrue(dt.Rows[0][8].ToString() == "pk_event_code");

                Assert.IsTrue(dt.Rows[1][0].ToString() == "athlete");
                Assert.IsTrue(dt.Rows[1][1].ToString() == "code");
                Assert.IsTrue(dt.Rows[1][2].ToString() == "game");
                Assert.IsTrue(dt.Rows[1][3].ToString() == "athlete_code");
                Assert.IsTrue(dt.Rows[1][4].ToString() == "1");
                Assert.IsTrue(dt.Rows[1][5].ToString() == "1");
                Assert.IsTrue(dt.Rows[1][6].ToString() == "1");
                Assert.IsTrue(dt.Rows[1][7].ToString() == "fk_game_athlete_code");
                Assert.IsTrue(dt.Rows[1][8].ToString() == "pk_athlete_code");
            }
        }
        ...
        public void GetColumnsTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                Assert.AreEqual(dt.Rows[0][3].ToString(), "host_year");
                Assert.AreEqual(dt.Rows[1][3].ToString(), "event_code");
            }
        }
        ...
        public void GetIndexesTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                Assert.AreEqual(dt.Columns.Count, 9);
                Assert.AreEqual(dt.Rows.Count, 5);

                Assert.AreEqual(dt.Rows[3][2].ToString(), "pk_game_host_year_event_code_athlete_code"); //Index name
                Assert.AreEqual(dt.Rows[3][4].ToString(), "True"); //Is PK?
            }
        }
        ...
        public void GetUsersTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                Assert.AreEqual(dt.Rows[0][0].ToString().ToUpper(), "DBA");
                Assert.AreEqual(dt.Rows[1][0].ToString().ToUpper(), "PUBLIC");
            }
        }
        ...
        public void GetProceduresTest()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                int nColsCount = 7, nRowsCount = 2;

                Assert.AreEqual(dt.Columns.Count, nColsCount);
                Assert.AreEqual(dt.Rows.Count, nRowsCount);

                string strProcedure1 = "phone_info", strProcedure2 = "hello";
                Assert.AreEqual(dt.Rows[0][0].ToString(), strProcedure1);
                Assert.AreEqual(dt.Rows[1][0].ToString(), strProcedure2);
            }
        }
        ...
        public void Test_SchemaProvider_FunctionTypes()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                Assert.IsTrue(rw.Rows[0][0].ToString() == "ABSOLUTE");
                Assert.IsTrue(rw.Rows[rw.Rows.Count - 1][0].ToString() == "ZONE");
            }
        }
