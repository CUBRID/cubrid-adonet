    ...
    public class CUBRIDConnectionTest
    {
                ...
                try
                {
                    ...
                    //DataTable dt = new DataTable();
                    {
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.AreEqual(dt.Rows[0]["USERNAME"].ToString(), "DBA");
                            Assert.AreEqual(dt.Rows[1]["USERNAME"].ToString(), "PUBLIC");
                        }
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.AreEqual(dt.Rows[0]["CATALOG_NAME"].ToString(), "demodb");
                            Assert.AreEqual(dt.Rows[0]["SCHEMA_NAME"].ToString(), "demodb");
                        }
                        ...
                        {
                            Assert.AreEqual(dt.Rows.Count, 1);
                            Assert.AreEqual(dt.Rows[0]["TABLE_CATALOG"].ToString(), "demodb");
                            Assert.AreEqual(dt.Rows[0]["TABLE_SCHEMA"].ToString(), "demodb");
                            Assert.AreEqual(dt.Rows[0]["TABLE_NAME"].ToString(), "nation");
                        }
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.AreEqual(dt.Columns[0].ColumnName, "VIEW_CATALOG");
                            Assert.AreEqual(dt.Columns[1].ColumnName, "VIEW_SCHEMA");
                            Assert.AreEqual(dt.Columns[2].ColumnName, "VIEW_NAME");
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.AreEqual(dt.Rows[0]["TABLE_CATALOG"].ToString(), "demodb");
                            Assert.AreEqual(dt.Rows[0]["TABLE_SCHEMA"].ToString(), "demodb");
                            Assert.AreEqual(dt.Rows[0]["TABLE_NAME"].ToString(), "game");
                            Assert.AreEqual(dt.Rows[0]["COLUMN_NAME"].ToString(), "event_code");
                            Assert.AreEqual((uint)dt.Rows[0]["ORDINAL_POSITION"], (uint)1);
                            Assert.AreEqual(dt.Rows[0]["COLUMN_DEFAULT"].ToString(), "");
                            Assert.AreEqual((bool)dt.Rows[0]["IS_NULLABLE"], false);
                            Assert.AreEqual(dt.Rows[0]["DATA_TYPE"].ToString(), "INTEGER");
                            Assert.AreEqual((uint)dt.Rows[0]["NUMERIC_PRECISION"], (uint)10);
                            Assert.AreEqual((uint)dt.Rows[0]["NUMERIC_SCALE"], (uint)0);
                            Assert.AreEqual((byte)dt.Rows[0]["CHARACTER_SET"], (byte)0);
                        }
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.IsTrue(dt.Rows[0]["PKTABLE_NAME"].ToString() == "event");
                            Assert.IsTrue(dt.Rows[0]["PKCOLUMN_NAME"].ToString() == "code");
                            Assert.IsTrue(dt.Rows[0]["FKTABLE_NAME"].ToString() == "game");
                            Assert.IsTrue(dt.Rows[0]["FKCOLUMN_NAME"].ToString() == "event_code");
                            ...
                            Assert.IsTrue(dt.Rows[0]["FK_NAME"].ToString() == "fk_game_event_code");
                            Assert.IsTrue(dt.Rows[0]["PK_NAME"].ToString() == "pk_event_code");
                        }
        ...
        public void CloneTest()
        {
            using (CUBRIDConnection target = new CUBRIDConnection())
            {
                ...
                {
                    actual.Open();
                    actual.ConnectionString = "server=localhost;database=demodb;port=33690;user=public;password=";
                }
                catch (Exception ex)
                {
        ...
        public void SetLockTimeoutTest()
        {
            using (CUBRIDConnection target = new CUBRIDConnection())
            {
                ...
                try
                {
                    target.SetLockTimeout(1000);
                }
                catch (Exception ex)
                {
                    Assert.AreEqual(ex.Message, "The connection is not open!");
                }

                //target.SetLockTimeout(35);
                target.Open();                
                target.SetLockTimeout(35 * 1000);
                Assert.AreEqual(target.GetLockTimeout(), 35 * 1000);
        ...
        public void CurrentDatabaseTest()
        {
            using (CUBRIDConnection target = new CUBRIDConnection())
            {
                try
                {
                    target.ConnectionString = "server=10.34.64.122;port=33690;user=public;password=;charset=utf-8";
                    target.Open();
                }
                catch (Exception ex)
                {
        ...
        public void Test_BatchExecute()
        {
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                CUBRIDConnectionTest.ExecuteSQL("drop table if exists t", conn);
        ...
        {
            string strURL = "cci:cubrid:10.34.64.121:33690:demodb:public::?logSlowQueries=true" +
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                try
                {
                    string strURL2 = "cci:cubrid:10.34.64.121:33690:demodb:public::?logSlowQueries=true" +
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                using (CUBRIDCommand cmd = new CUBRIDCommand(sql, conn))
                {
                    using (CUBRIDDataReader reader = (CUBRIDDataReader)cmd.ExecuteReader())
                    {
                        ...
                        reader.Read();
                        Assert.AreNotEqual(215, reader.GetInt32(0));
