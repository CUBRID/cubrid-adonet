    ...
    public class CUBRIDConnectionTest
    {
                ...
                try
                {
                    ...
                    //DataTable dt = new DataTable();
                    {
                        ...
                        if (dt != null)
                        {
                            ...
                            Assert.IsTrue((uint)dt.Rows[0]["NUMERIC_PRECISION"] == (uint)10);
        ...
        public void CloneTest()
        {
            using (CUBRIDConnection target = new CUBRIDConnection())
            {
                ...
                {
                    actual.Open();
                    actual.ConnectionString = "server=localhost;database=demodb;port=33590;user=public;password=";
                }
                catch (Exception ex)
                {
        ...
        public void CurrentDatabaseTest()
        {
            using (CUBRIDConnection target = new CUBRIDConnection())
            {
                try
                {
                    target.ConnectionString = "server=10.34.64.122;port=33590;user=public;password=;charset=utf-8";
                    target.Open();
                }
                catch (Exception ex)
                {
        ...
        {
            string strURL = "cci:cubrid:10.34.64.121:33590:demodb:public::?logSlowQueries=true" +
                            "&slowQueryThresholdMillis=1000&logTraceApi=true&logTraceNetwork=true" +
                            "&autoCommit=false&althosts=10.34.64.122,10.34.64.122:33590&" +
            ...
            using (CUBRIDConnection conn = new CUBRIDConnection())
            {
                ...
                try
                {
                    string strURL2 = "cci:cubrid:10.34.64.121:33590:demodb:public::?logSlowQueries=true" +
        ...
        {
            string strURL = "cci:cubrid:10.34.64.122:33590:demodb:public::?logSlowQueries=true" +
